...
<head>
	<meta charset="UTF-8">
	<title>EL expressive language</title>
...
<body style="margin: 40px;">
	...
	<table border="1">
		...
		<tr><th>비교연산 표현식</th><th>결과</th></tr>
		<tr><td>\${20 == 10}</td><td>${20 == 10}</td></tr>
		<tr><td>\${20 eq 10}</td><td>${20 eq 10}</td></tr>
		<tr><td>\${20 ne 10}</td><td>${20 ne 10}</td></tr>
		<tr><td>\${"hello" == "bye"}</td><td>${"hello" == "bye"}</td></tr>
		<tr><td>\${"hello" eq "bye"}</td><td>${"hello" eq "bye"}</td></tr>
		<tr><td>\${20 > 10}</td><td>${20 > 10}</td></tr>
		<tr><td>\${20 gt 10}</td><td>${20 gt 10}</td></tr>
		<tr><td>\${20 ge 10}</td><td>${20 ge 10}</td></tr>
		<tr><th>논리연산 표현식</th><th>결과</th></tr>
		<tr><td>\${20 > 10 && "hello" == "bye"}</td><td>${20 > 10 && "hello" == "bye"}</td></tr>
		<tr><td>\${20 gt 10 and "hello" eq 'bye'}</td><td>${20 gt 10 and "hello" eq 'bye'}</td></tr>
		<tr><td>\${20 gt 10 or "hello" eq "bye"}</td><td>${20 gt 10 or "hello" eq "bye"}</td></tr>
		<tr><td>\${not ("hello" eq "bye")}</td><td>${not ("hello" eq "bye")}</td></tr>
		...
		<tr><td>\${empt}</td><td>${empt}</td></tr>
	</table>
	<h3>사례</h3>
	<ul>
		<li>파라미터 값은 ${empty param.num ? '입력하지 않음' : param.num }</li>
